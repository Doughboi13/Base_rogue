...
# Comments are the building blocks of a camera
...
class Enemy(pygame.sprite.Sprite):
    ...
    def animate(self):
        ...
        up_animations = [self.game.enemy_spritesheet.get_sprite(3, 34, self.width, self.height),
                         ...
                         self.game.enemy_spritesheet.get_sprite(68, 34, self.width, self.height)]''' # up and down animations
        ...
        if self.facing == "up":
            if self.y_change == 0:
                ...
                self.animation_loop += 0.1
                if self.animation_loop >= 3:
                    self.animation_loop = 1''' # up and down animations
